...
public class NguyenMinhQuan_20098151_ChuyenDoCSangDoFBoxLayout extends JFrame implements ActionListener{
	private JTextField textDoC;
	private JButton btnChuyenDoi;
	private JButton btnThoat;
	private JLabel lblKetQua;
	NguyenMinhQuan_20098151_ChuyenDoCSangDoFBoxLayout(){
		doShow();
		addControl();
		setVisible(true);
	}
	...
	public static void main(String[] args) {
		new NguyenMinhQuan_20098151_ChuyenDoCSangDoFBoxLayout();
	}
}
