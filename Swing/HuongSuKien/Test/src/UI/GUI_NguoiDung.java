...
public class GUI_NguoiDung extends JFrame implements ActionListener {
	...
	private DAO_NhanSu daoNhanSu;
	private TaiKhoan taiKhoan;
	private JRadioButton radNam, radNu;
	private JDateChooser dateNgaySinh;
	private JButton btnLuuThongTin, btnDoiMatKhau;
	private NhanSu nhanSu;
	private JPasswordField currentPassword, confirmPassword, newPassword;
	...
	public Component tabNguoiDung() {
		daoNhanSu = new DAO_NhanSu();
		this.nhanSu = daoNhanSu.getNhanSu(taiKhoan);
	...
	public Hashtable<String, String> login(JFrame frame) {
		...
		do {
			response = JOptionPane.showConfirmDialog(frame, pnTong, "Đổi mật khẩu", JOptionPane.OK_CANCEL_OPTION, JOptionPane.DEFAULT_OPTION);
		...
		if (action == btnLuuThongTin) {
			if (valid()) {
				...
				if (nhanSu.equals(nhanSuMoi)) {
					...
					if (daoNhanSu.suaNhanSuTuNguoiDung(nhanSuMoi)) {
